...
if __name__ == "__main__" :
    ...
    for e in range(EPISODES):
        ...
        for time in range(max_env_steps): 
            ...
            # Save Results
            # if(time == 0):
            #     with open("/home/mnc/ns3-son/Baseline/NS3_SON/Reward_1159.txt", 'w',encoding="UTF-8") as k:
            #         k.write(str(RewardSum)+"\n")
            # else:
            #     with open("/home/mnc/ns3-son/Baseline/NS3_SON/Reward_1159.txt", 'a',encoding="UTF-8") as k:
            #         k.write(str(RewardSum)+"\n")
