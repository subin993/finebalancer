...
if __name__ == "__main__" :
    ...
    for e in range(EPISODES):
        ...
        ##
        state5 = np.reshape(state['TotalCqi'], [5,1])
        state5 = state5[2:5,0:1]
        TotalCqi = state5[0][0]
        print("TotalCQI: ", TotalCqi)
        ...
        for time in range(max_env_steps): 
            ...
            # Save Results
            # if(time == 0):
            #     with open("/home/mnc/ns3-son/Baseline/NS3_SON/Reward_1161.txt", 'w',encoding="UTF-8") as k:
            #         k.write(str(RewardSum)+"\n")
            # else:
            #     with open("/home/mnc/ns3-son/Baseline/NS3_SON/Reward_1161.txt", 'a',encoding="UTF-8") as k:
            #         k.write(str(RewardSum)+"\n")
