        ...
        for time in range(max_env_steps):
            ...
            for agent_id, agent in enumerate(agents):
                if (np.random.rand() <= epsilon) :
                    ...
                    env_action1 = round(action1 * 0.5,0)
                    ...
                    env_action1 = float(np.round(action[0] * 0.5,0).astype(float))
            ...
            # Save Results
            # if(time == 0):
            #     with open("/home/mnc2/Eunsok/Baseline/NS3_SON/Reward_1171.txt", 'w',encoding="UTF-8") as k:
            #         k.write(str(RewardSum)+"\n")
            # else:
            #     with open("/home/mnc2/Eunsok/Baseline/NS3_SON/Reward_1171.txt", 'a',encoding="UTF-8") as k:
            #         k.write(str(RewardSum)+"\n")
