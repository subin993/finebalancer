    ...
    for e in range(EPISODES):
        ...
        for time in range(max_env_steps): 
            ...
            if (total_step < start_step):
                ...
                action1 = action1[2:5]
                action2 = action2[2:5]
                action1 = (np.round(action1,0)).astype(float)
                action2 = (np.round(action2,0)).astype(float)
                action = np.concatenate([action1,action2])
                env_action = action.tolist()
                env_action.insert(0,0.0)
                env_action.insert(0,0.0)
                env_action.insert(5,0.0)
                env_action.insert(5,0.0)
            ...
            # Save Results
            # if(time == 0):
            #     with open("/home/mnc2/Eunsok/Baseline/NS3_SON/Reward_1151.txt", 'w',encoding="UTF-8") as k:
            #         k.write(str(RewardSum)+"\n")
            #     with open("/home/mnc2/Eunsok/Baseline/NS3_SON/Loss_1151.txt", 'w',encoding="UTF-8") as j:
            #         j.write(str(agent.critic_loss)+"\n")
            # else:
            #     with open("/home/mnc2/Eunsok/Baseline/NS3_SON/Reward_1151.txt", 'a',encoding="UTF-8") as k:
            #         k.write(str(RewardSum)+"\n")
            #     with open("/home/mnc2/Eunsok/Baseline/NS3_SON/Loss_1151.txt", 'a',encoding="UTF-8") as j:
            #         j.write(str(agent.critic_loss)+"\n")
