...
public:
   ...
   */
  NetDeviceContainer InstallEnbDevice (NodeContainer c, Ptr<MyGymEnv> son_server);
   ...
   * \return the NetDeviceContainer with the newly created devices
   */
  NetDeviceContainer InstallUeDevice (NodeContainer c, Ptr<MyGymEnv> son_server);
...
private:
   ...
   */
  Ptr<NetDevice> InstallSingleEnbDevice (Ptr<Node> n, Ptr<MyGymEnv> son_server,int totalN);
   ...
   * \return pointer to the created device
   */
  Ptr<NetDevice> InstallSingleUeDevice (Ptr<Node> n, Ptr<MyGymEnv> son_server);
